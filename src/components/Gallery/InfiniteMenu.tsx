...
const defaultItems: MenuItem[] = [
  {
    ...
    description: 'Fetching unique artworks...'
  }
];
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-near-black">
      <canvas
          ...
          <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-8 md:p-12">
            ...
            <h2
              className={`
                select-none
                font-black
                text-[1.5rem] sm:text-[2.5rem] md:text-[4rem]
                text-warm-ivory
                transition-all
                ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
                md:absolute md:top-1/2 md:left-[1.6em] md:-translate-y-1/2
                ${
                  isMoving
                    ? 'opacity-0 translate-y-[-20px] md:translate-y-[-50%] md:translate-x-[10%] duration-[100ms]'
                    : 'opacity-100 translate-y-0 md:translate-y-[-50%] md:translate-x-[20%] duration-[500ms]'
                }
              `}
            >
              {activeItem.title}
            ...
            <p
              className={`
                select-none
                max-w-[15ch]
                text-[0.85rem] sm:text-[1.2rem] md:text-[1.5rem]
                text-aged-gold
                font-serif
                italic
                transition-all
                ...
                ${
                  isMoving
                    ? 'opacity-0 translate-y-[20px] md:translate-y-[-50%] md:translate-x-[-60%] duration-[100ms]'
                    : 'opacity-100 translate-y-0 md:translate-y-[-50%] md:translate-x-[-90%] duration-[500ms]'
                }
              `}
            >
            ...
            className={`
              ...
              ${
                isMoving
                  ...
                  : 'bottom-[1.5em] md:bottom-[3.8em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
              }
            `}
          >
            <p className="select-none relative text-near-black top-[1px] text-[20px] md:text-[26px]">&#x2197;</p>
          </div>
        </>
      )}
    </div>
