      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-32">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start z-10">
          ...
          <div className="font-sans font-light text-ghost-white/70 leading-relaxed space-y-6 max-w-lg mb-12">
            ...
            <p>
              As the former principal of Appasaheb Kadadi Chitrakala Mahavidyalaya, Solapur, Deepak now focuses exclusively on his studio practice. His extensive work has earned him the Nehru Cultural Award, Prafulla Dahanukar Art Foundation recognition, and spots in prominent private collections spanning from India to the US and UK.
            </p>
          </div>
